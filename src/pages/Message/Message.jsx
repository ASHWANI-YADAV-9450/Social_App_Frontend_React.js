        ...
        <div className="flex h-full justify-between space-x-2">
         ...
         <div className="flex space-x-4 items-center py-5">
          ...
          <div className="h-[83vh] ">
            ...
            <div className="h-full space-y-4 mt-5 border overflow-y-scroll  hideScrollBar ">
        ...
        {currentChat ?  <div>
          <div className="flex justify-between items-center border-2 p-5">
            <div className="flex items-center space-x-3">
              <Avatar src="https://images.pexels.com/photos/20162029/pexels-photo-20162029/free-photo-of-a-skateboarder-in-the-air.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load" />
          ...
          {selectedImage && <img className="w-[5rem] h-[5rem] object-cover px-2"
            ...
            <div className="py-5 flex items-center justify-center space-x-5">
              ...
              onKeyPress={(e)=>{
               ...
               className="bg-transparent border border-[#3b4054] rounded-full w-[90%] py-3 px-5" placeholder="Type message...." type="text" />
              <div>
